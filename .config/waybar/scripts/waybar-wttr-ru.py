...
weather = requests.get("https://wttr.in/?format=j1&lang=ru").json()
...
data['tooltip'] = f"<b>{weather['current_condition'][0]['lang_ru'][0]['value']} {weather['current_condition'][0]['temp_C']}°C</b>\n"
data['tooltip'] += f"Ощущается как: {weather['current_condition'][0]['FeelsLikeC']}°C\n"
data['tooltip'] += f"Ветер: {weather['current_condition'][0]['windspeedKmph']//3.6}м/с\n"
