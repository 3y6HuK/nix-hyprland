...
- Присутствует настройка для вывода окна мессенджеров на отдельные тэги, в том числе мессенджера MAX. Сохраните пакет AppImage в любое удобное место, и отредактируйте конфиг `~/.config/hypr/hyprland.conf`, Строки номер 292-293;
